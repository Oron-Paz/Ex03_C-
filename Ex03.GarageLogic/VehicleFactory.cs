...
namespace Ex03.GarageLogic
{
    public class VehicleFactory
    {
        ...
        public static FuelCar CreateFuelCar(string i_modelName, string i_licenseNumber, float i_remainingEnergy, string i_OwnerName, string i_OwnerPhoneNumber, VehicleStatus i_vehicleStatus, CarColor i_color, int i_doors)
        {  
        ...
        public static ElectricCar CreateElectricCar(string i_modelName, string i_licenseNumber, float i_remainingEnergy, string i_OwnerName, string i_OwnerPhoneNumber, VehicleStatus i_vehicleStatus, CarColor i_color, int i_doors)
        {
