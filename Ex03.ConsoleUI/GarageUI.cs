...
public class GarageUI
{
    ...
    private static void InsertNewVehicle()
    {
        ...
        if (option == "1")
        {
            ...
            garage.vehicles.Add(VehicleFactory.CreateFuelCar(licenseNumber, modelName, remainingEnergy, ownerName, ownerPhoneNumber, VehicleStatus.InRepair, carColor, doors, remainingFuelLiters));
        ...
        else if (option == "2")
        {
            ...
            garage.vehicles.Add(VehicleFactory.CreateElectricCar(licenseNumber, modelName, remainingEnergy, ownerName, ownerPhoneNumber, VehicleStatus.InRepair, carColor, doors, remainingEngineTime));
        ...
        else if (option == "3")
        {
            ...
            garage.vehicles.Add(VehicleFactory.CreateFuelMotorcycle(licenseNumber, modelName, remainingEnergy, ownerName, ownerPhoneNumber, VehicleStatus.InRepair, licenseType, engineVolume, remainingFuelLiters));
        ...
        else if (option == "4")
        {
            ...
            garage.vehicles.Add(VehicleFactory.CreateElectricMotorcycle(licenseNumber, modelName, remainingEnergy, ownerName, ownerPhoneNumber, VehicleStatus.InRepair, licenseType, engineVolume, remainingEngineTime));
            Console.WriteLine($"\nFuel motorcycle with license number {licenseNumber} was added to garage.\n");
            return;
        }
        else if (option == "5")
        {
            ...
            garage.vehicles.Add(VehicleFactory.CreateTruck(licenseNumber, modelName, remainingEnergy, ownerName, ownerPhoneNumber, VehicleStatus.InRepair, isCarryingDangerousMaterials, cargoVolume, remainingFuelLiters));
        }
        else
        {
            Console.WriteLine("Invalid option, try again.");
